...
[<i class="fas fa-arrow-alt-circle-left"></i> Seção 1](https://CREF-UFRGS.github.io/TutorialIM/){:
.btn .btn--primary}[ Seção 3 <i class="fas fa-arrow-alt-circle-right"></i>](https://CREF-UFRGS.github.io/TutorialIM/secao3/){:
.btn .btn--warning}
{: .text-right} 
